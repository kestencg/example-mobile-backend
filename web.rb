...
Dotenv.load
Stripe.api_key = "sk_test_51H5OsQKi7D1cY0XHzEHI98P1vgdHbaaGYvwALVFF22FA2imhEgoQFihlWwusiBv7OUq4HnkpHKqDLsRy8bN6WIXo00xQfxLHZv"
...
def authenticate!
  ...
  if session.has_key?(:customer_id)
    ...
    default_customer_id = 'cus_I3mrnuM9oeSuM7'
